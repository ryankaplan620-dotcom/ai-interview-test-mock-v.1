 ...
 *   - Em-dashes converted to periods or commas. David had 4 em-dashes,
 *     several inside dialogue ("That doesn't pencil. Walk me through it
 *     again." — originally "— be precise") which TTS renders as awkward
 *     pauses.
 *   - Added explicit prompt-injection / stay-in-character guardrail
 *     (Priya, Marcus, Sarah all have one; David's section was silent on it).
 *   - Kept David's intentionally terse opening — matches his character.
 */
